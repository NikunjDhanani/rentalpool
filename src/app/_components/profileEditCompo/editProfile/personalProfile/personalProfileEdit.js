...
const PersonalProfileEdit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (typeof formData.profileImage === "object") {
      profilePics = formData.profileImage;
    }

    const formDataToSend = new FormData();
    formDataToSend.append("first_name ", firstName);
    formDataToSend.append("last_name ", lastName);
    profilePics && formDataToSend.append("profile_photo ", profilePics);
          ...
          <div className={styles.edit_profile_tab_container}>
            ...
            {profileType === "personal" && (
              <div className={styles.edit_profile_tab_content}>
                <div
                  className={styles.my_account_content_section}
                  id="personal"
                >

  ...
  return (
    <div className="footer">
      <div className="container footermain">
        <div className="fotterdiv1">
         <Link href="/"> <Image src="/assets/footer/logo.png" width={132} height={149} alt="logo"/></Link>
          <p>Copyright © 2023 RentalsPool App. All Rights Reserved.</p>
        </div>

        <div className="footerdiv2main">
          <div className="fotterdiv2">
            <h3>Useful Links</h3>
        ...
        <div className="fotterdiv3">
          <h3>Get App</h3>
          <div className="d-flex flex-column gap-2 plycon">
            <Image src="/assets/footer/playstore.png" width={154} height={45} alt="playstore"/>
            <Image src="/assets/footer/appstor.png" width={154} height={45} alt="appstor"/>
          </div>
